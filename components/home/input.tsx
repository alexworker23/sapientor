...
export const SourceInput = () => {
  ...
  return (
    <div className="relative w-full max-w-[90%] sm:max-w-lg m-auto mt-20">
      <div className="w-full absolute bottom-0 left-0">
        <div className="overflow-hidden flex flex-col w-full shadow-md focus-within:shadow-lg divide-slate-600 min-h-12 bg-slate-50 focus-within:shadow-black/40 rounded-2xl transition-all">
          <div
            ...
            className={cn(
              "z-0 grid grid-cols-1 sm:grid-cols-3 gap-x-4 gap-y-2 transition-all duration-300 ease-in-out",
              hasFiles ? "border-b" : ""
            )}
          >
            {files?.map((file) => (
              <div
                ...
                className="flex relative items-center gap-2 w-full hover:bg-slate-100 justify-center rounded-md transition-colors group m-2.5"
              >
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div
                        ...
                        className="absolute -top-2.5 -right-2.5 w-5 h-5 justify-center items-center group-hover:flex hidden rounded-full bg-white cursor-pointer"
                      >
                        <X size={12} />
                      </div>
                    </TooltipTrigger>
