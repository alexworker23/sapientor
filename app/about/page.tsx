    ...
    <>
      <main className="mx-auto max-w-3xl px-5 py-20 min-h-screen">
        <section className="mb-20">
          ...
          <p>
            With our app you don&apos;t have to be a developer or spend your
            time in order to gather the data you need into some file. You can
            just insert the link for an article, or a video, or a podcast and be
            sure that this data will added into your Knowledge Hub
            automatically.
          </p>
        </section>
      </main>
